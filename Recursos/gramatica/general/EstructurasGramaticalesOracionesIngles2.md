# Documento: Estructuras Gramaticales de Oraciones - Inglés II
...
| **Comparativo (Adjetivos Largos)**| Sujeto + verbo + more + Adj + than + Objeto | *The boys are more popular than girls.* |
| **Superlativo** | Sujeto + verbo + the + Adj+est / most + Adj + Comp. | *Mike is the tallest boy.* |
...
| **Preguntar por Existencia** | Is/Are + there + (a/an/any) + lugar + near here? | *Is there a bank near here?* |
...
| **Preguntar Precio** | How much + is/are + Sujeto? | *How much is the pizza?* |
...
| **Pasado Simple (Pregunta)** | (Wh-) + did + Sujeto + Verbo(base) + Comp. | *Where did you go yesterday?* |
...
| **Recomendación (Should)** | Sujeto + should/shouldn't + Verbo(base) + Comp. | *You should take an aspirin.* |
...
| **Hacer Invitación (Would like)**| Would you like to + Verbo(base) + Complemento? | *Would you like to go to the movies?* |
| **Aceptar/Rechazar (Would like)**| I would like to / I'd like to + (but I can't / have to) | *I would like to go with you but I can't.* |